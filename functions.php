...
function we_revolt_setup(): void {
	/*
		...
		* If you're building a theme based on We Revolt, use a find and replace
		* to change 'we-revolt' to the name of your theme in all the template files.
		*/
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'we_revolt_custom_background_args',
			array(
